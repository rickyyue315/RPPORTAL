...
import { generateTemplateWorkbook, buildSapExportBuffer, buildAuditExportBuffer } from '../lib/excelExport.js';
...
/** PUT /api/admin/submissions/:id — admin edits all business fields. */
adminRouter.put(
  '/submissions/:id',
  requireAdmin,
  adminActionLimiter,
